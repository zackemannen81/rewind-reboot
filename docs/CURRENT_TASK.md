...
- [ ] Unreal Editor Win64 Development build succeeds
- [ ] MCP handshake and toolset inventory observed from localhost:8000
- [ ] StartPIE, IsPIERunning and StopPIE observed
- [ ] PIE player transform or input-dependent log changes after injected input
- [ ] ReleaseAll leaves no project-injected held keys
- [ ] Viewport capture and log retrieval observed
- [ ] Automation-test toolset and test discovery observed
...
- `Rewind/Config/DefaultEditor.ini`
- `.mcp.json`
- `docs/paused/REW-0007_complete-the-chapter-1-spatial-chain.md`

## Checklist

- [x] Claim REW-0008 on `main`
- [x] Freeze this bounded child charter and pause REW-0007
- [ ] Write and route the canonical editor automation guide
- [ ] Enable the engine automation-test toolset
- [ ] Implement the project PIE-input toolset
- [ ] Build with Unreal Editor closed
- [ ] Restart the editor and run the MCP verification gates
- [ ] Update durable status, system document and file map
- [ ] Add a signed journal entry, archive this task and restore REW-0007
...
- [ ] Raw MCP tool discovery
- [ ] End-to-end PIE input scenario
- [ ] Viewport and log evidence retrieval
...
- Current state: Ready. Claim `286b087` is on `main`; implementation has not
  started.
- Next recommended step: inspect the bundled toolset API and implement the
  smallest editor-only PIE input bridge.
- Blockers: Unreal Editor must be closed before the full module build.
- Child tasks: none.
- Resume condition: none; work may proceed through source changes before the
  editor closes.
- Open questions: none.
...
- Restore paused REW-0007 unchanged to `docs/CURRENT_TASK.md`.
