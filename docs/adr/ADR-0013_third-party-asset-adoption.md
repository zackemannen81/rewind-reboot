...
The owner approves this record, or names the numbers to change. Until the status
line reads `Accepted`, no task may cite it, and the tracked closure rule in
ADR-0011 stands unamended.
