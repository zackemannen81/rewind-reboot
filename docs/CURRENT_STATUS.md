...
| `docs/CURRENT_TASK.md` | REW-0014 is Ready: adopt the owner's placed `4c_camera` as the exact initial runtime frame for Apartment 4C while preserving the region camera system |
