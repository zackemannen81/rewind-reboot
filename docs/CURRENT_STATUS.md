...
- **Heard evidence for the audio.** REW-0035 wired all fifteen sounds into
  ...
  cannot disagree. REW-0037 corrects the detached-camera listener and its suite
  passes 25/25, including an engine-result test of player-root position and
  authored-camera orientation through possession and reset refreshes. None of
  that is evidence that the room sounds right: nobody has heard it in play.
