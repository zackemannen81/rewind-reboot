...
- [x] The journal entry lists every asset created and names what was verified
  and what was not.
...
- [x] Track the source JPEGs and provenance record.
- [x] Import and configure the twelve textures through a committed editor script.
- [x] Create and verify the eight surface material instances.
- [x] Build with the editor closed and run the headless automation suite.
- [x] Update status, file map and journal.
- [x] Archive the completed charter and restore this template.
...
- [x] Read back all texture and instance settings from the saved Unreal assets.
- [x] Editor-closed build.
- [x] Full `Rewind.*` automation run, headless.
- [x] `git diff --check`.
...
- Current state: complete; the import script read back all twelve textures and eight instances.
- Next recommended step: a later look pass may assign instances and judge texel density in-game.
- Blockers: none.
- Child tasks: none.
