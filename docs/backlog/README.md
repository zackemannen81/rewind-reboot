...
| [`handmade-level-adoption.md`](handmade-level-adoption.md) | Proposed; stairwell foundation complete | REW-0010 stabilized the owner reference and built a traversable human-scale stairwell; complete map adoption and camera coverage remain unactivated |
